  ...
  <div>
    <div class="container">
        ...
        <div class="col-md-6 col-lg-6">
          <div class="text-left pt-20 pb-20">
            <p class="text-black text-uppercase">
              ...
              UnAvailable Products for Jan 2020
            </p>
          </div>
        </div>
        <div class="col-md-6 col-lg-6">
      ...
      <div>
        ...
        <div class="card p-0 order-filter-list" v-else>
          <div class="card-body p-0">
            ...
            >
              ...
              <template v-slot:cell(customer)="data">
                <div class="d-none d-lg-block d-md-block d-xl-block tooltip-data">
                  <span class="tolltip-data">{{ data.value.name }}</span>
                  <span class="tooltiptext">{{ data.value.name }}</span>
                </div>
              </template>
...
<script src="./unavailableProducts.js"></script>
<style src="./unavailableProducts.scss" lang="scss" scoped />
